...
_piece get_rotated_piece(_piece_type piece_type) {
    switch (piece_type) {
        case La: return La_piece;
        case Lb: return Lb_piece;
        case Lc: return Lc_piece;
        case Ld: return Ld_piece;

        case Ta: return Ta_piece;
        case Tb: return Tb_piece;
        case Tc: return Tc_piece;
        case Td: return Td_piece;

        case Ja: return Ja_piece;
        case Jb: return Jb_piece;
        case Jc: return Jc_piece;
        case Jd: return Jd_piece;

        case Za: return Za_piece;
        case Zb: return Zb_piece;

        case Sa: return Sa_piece;
        case Sb: return Sb_piece;

        case Ia: return Ia_piece;
        case Ib: return Ib_piece;

        case SQUARE: return Square_piece;

        default: fprintf(stderr, "Invalid piece in rotate_piece\n"); abort();
    }
}
...
int get_piece_rotation(_piece_type piece_type) {
    switch (piece_type) {
        ...
        default: fprintf(stderr, "Invalid piece on get_piece_rotation\n"); abort();
    }
}
...
_piece get_piece_coord_from_id(_piece_type piece_type) {
    switch (piece_type) {
        ...
        case Lb:
        case Lc:
        case Ld: return La_piece;

        case Ta:
        case Tb:
        case Tc:
        case Td: return Ta_piece;

        case Ja:
        case Jb:
        case Jc:
        case Jd: return Ja_piece;

        case Za:
        case Zb: return Za_piece;

        case Sa:
        case Sb: return Sa_piece;

        case Ia:
        case Ib: return Ia_piece;

        case SQUARE: return Square_piece;

        default: fprintf(stderr, "Invalid piece in get_piece_coord_from_id\n"); abort();
    }
}
